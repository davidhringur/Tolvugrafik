...
window.onload = function init()
{
    ...
    window.addEventListener('arrowUp',function(e){
...
function render()
{
    ...
    mv = mult( mv, rotateY( -rotYear ) );  // Lögun svo snúningsás jarðar breytist ekki, í snúningnum, það verður einhvertíman að koma sumar á íslandi.
    ...
    // teikna "gervihnött" sem snýst yfir póla tunglsins
    var mvg = mult( mvt, rotateZ( 30.0*rotDay ) );
