...
window.onload = function init() {
    ...
    document.getElementById("btnChangeBlinn-Phong").onclick = function(){
        gl.uniform1i( gl.getUniformLocation(program, "Blinn"), 1 );
    };
    document.getElementById("btnChangePhong").onclick = function(){
        gl.uniform1i( gl.getUniformLocation(program, "Blinn"), 0 );
    };
